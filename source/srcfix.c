...
int     verbose,kill_dbg,ntabs,ovrwrit,disp,cont,cmpdir,indepth,ininc,up_in_place;
...
#ifdef __STDC__
printf("Subject, Wills & Company -- Version 6.00003 --- %s\n",__DATE__);
#else
printf("Subject, Wills & Company -- Version 6.00003 --- \n");
#endif
...
{
int     ii,kk,jj,ptri,ptro,vptr,org;
